...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary mx-3">
        <div class="container-fluid">
          <a class="navbar-brand" href="<?php echo substr($actual_link,0,6) ?>">TokoKu (Beli Produk)</a>
    ...
    <form class="w-50 ms-3 mt-3" method="POST" action="/admin/beli/{{ $dataProduk[0]->ID_produk }}">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="jumlahBarang" style="width:100px;" onkeydown="return false" onchange=myFunction() min=1 value="1" name="jumlah_produk">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Total Yang Harus Dibayar</label>
            <input type="number" class="form-control" id="totalHarga" value={{ $dataProduk[0]->harga_produk * 1}} name="total_harga" readonly="readonly">
        </div>
